...
struct ShaderState {
  ...
  GLfloat h_xWindowInvScale;             // implement
  GLfloat h_yWindowInvScale;             // implement
  ...
  ShaderState(const char* vsfn, const char* fsfn) {
    ...
    h_xWindowInvScale = safe_glGetUniformLocation(h, "xWindowInvScale");
    h_yWindowInvScale = safe_glGetUniformLocation(h, "yWindowInvScale");
...
static void display(void) {
  ...
  safe_glUniform1f(curSS.h_xWindowInvScale, (GLfloat) 512 / g_width);
  safe_glUniform1f(curSS.h_yWindowInvScale, (GLfloat) 512 / g_height);
...
static void initGlutState(int argc, char **argv) {
  ...
  glutCreateWindow("CS 30800: Hello World");    // title the window
